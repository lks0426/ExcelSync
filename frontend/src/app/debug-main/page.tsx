  ...
  return (
    <div className="min-h-screen p-4 md:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        {/* Header - Basic version without framer-motion */}
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <section className="space-y-6">
            ...
            {/* Simplified upload area instead of FileUpload component */}
        ...
        <div className="glass-card p-4 space-y-2">
          <h3 className="font-bold">Debug Main Page:</h3>
          <p>✅ Basic page structure: working</p>
          <p>✅ Icons: working</p>
          <p>✅ i18n: working</p>
          <p>✅ CSS classes: working</p>
          <p>⚠️ Components not loaded yet</p>
        </div>
      </div>
    </div>
  )
